...
<head>
	...
	<title>SmartMaid-Cemerlang</title>
	<!-- Bootstrap CSS -->
				...
				<div class="col-lg-10 col-md-9 col-6">
					...
					<div class="mainmenu">
						<ul id="primary-menu">
							...
							<li><a class="appao-btn" href="#">GABUNG</a></li>
						</ul>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="col-lg-7">
					<div class="hero-area-content">
						<h1>Anda Sedang Mencari Asisten Rumah Tangga Disini !!!</h1>
						<p>Layanan Asisten Rumah Tangga sebagai fasilitator yang menghubungkan antara para pencari asisten rumah tangga dan yayasan penyalur yang dipublikasikan melalui internet. Bekerjasama dengan yayasan penyalur asisten rumah tangga (ART).</p>
						<a href="#" class="appao-btn"><i class="fa fa-android" aria-hidden="true">&nbsp;Google Play</i></a>
						<a href="#" class="appao-btn"><i class="fa fa-apple" aria-hidden="true">&nbsp;App Store</i></a>
					</div>
				</div>
				<div class="col-lg-5">
	...
	<section class="about-area ptb-90">
		<div class="container">
			<div class="row">
				<div class="col-lg-12">
					<div class="sec-title">
						<h2>Tentang Kami<span class="sec-title-border"><span></span><span></span><span></span></span></h2>
						<p>Aplikasi berbasis android dibangun untuk layanan Asisten Rumah Tangga sebagai fasilitator yang menghubungkan antara para pencari asisten rumah tangga dan yayasan penyalur yang dipublikasikan melalui internet.</p>
					</div>
				</div>
			</div>
			<div class="row">
				<div class="col-lg-4">
					<div class="single-about-box">
						...
						<h4>UPDATE & BANYAK PILIHAN </h4>
						<p>Asisten Rumah Tangga yang terampil dan berkualitas? Penyalur mengupdate dan menawarkan pekerja yang ready sebanyak-banyaknya. Anda bisa menyeleksi dan merekrut yang terbaik. Tidak ada situs lain yang memberikan pilihan sebanyak itu.</p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="single-about-box active">
						<i class="icofont icofont-computer"></i>
						<h4>PENYALUR TERVERIFIKASI </h4>
						<p>Kami memverifikasi identitas dan alamat semua penyalur. Bila Anda bertransaksi langsung dengan situs sembarangan, maka Anda beresiko akan berinteraksi dengan penyalur fiktif atau tidak diketahui persis alamatnya. Tetapi, transaksi Anda di sini dipastikan aman karena semua penyalur sudah diverifikasi. Untuk keamanan maksimal. </p>
					</div>
				</div>
				<div class="col-lg-4">
					<div class="single-about-box">
						...
						<p>Anda bisa langsung klik "Pesan Sekarang" di profil pekerja yang Anda minati. Penyalur akan menghubungi Anda untuk membicarakan proses selanjutnya, seperti wawancara dan pengantaran. Bila Anda tidak jadi merekrut, Anda bisa klaim uang kembali 100%. Kami membayar semua klaim refund tanpa bertanya.</p>
					</div>
				</div>
			</div>
		</div>
